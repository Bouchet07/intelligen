...
def _check_reg_targets(y_true, y_pred, multioutput, dtype="numeric"):
    ...
    if isinstance(multioutput, str):
        if multioutput not in allowed_multioutput_str:
            raise ValueError(
                "Allowed 'multioutput' string values are {allowed_multioutput_str}. "
                "You provided multioutput={multioutput}"
            )
        ...
        if n_outputs == 1:
            ...
            raise ValueError(
                f"There must be equally many custom weights ({len(multioutput)}) as outputs ({n_outputs})."
            )
...
def mean_absolute_error(
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_absolute_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_pinball_loss(
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_pinball_loss
    >>> y_true = [1, 2, 3]
    ...
    if isinstance(multioutput, str):
        if multioutput == "raw_values":
            ...
            raise ValueError(
                ...
                f"or 'uniform_average' but we got {multioutput}"
                " instead."
            )
...
def mean_absolute_percentage_error(
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_absolute_percentage_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_squared_error(
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_squared_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def mean_squared_log_error(
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_squared_log_error
    >>> y_true = [3, 5, 2.5, 7]
    >>> y_pred = [2.5, 5, 4, 8]
...
def median_absolute_error(
    ...
    Examples
    --------
    >>> from intelligen.metrics import median_absolute_error
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def explained_variance_score(
    ...
    *,
    ...
    Examples
    --------
    >>> from intelligen.metrics import explained_variance_score
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def r2_score(
    ...
    *,
    ...
    Examples
    --------
    >>> from intelligen.metrics import r2_score
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
...
def max_error(y_true, y_pred):
    ...
    Examples
    --------
    >>> from intelligen.metrics import max_error
    >>> y_true = [3, 2, 7, 1]
    >>> y_pred = [4, 2, 7, 1]
...
def mean_tweedie_deviance(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_tweedie_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_poisson_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_poisson_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_gamma_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from intelligen.metrics import mean_gamma_deviance
    >>> y_true = [2, 0.5, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def d2_tweedie_score(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from intelligen.metrics import d2_tweedie_score
    >>> y_true = [0.5, 1, 2.5, 7]
    >>> y_pred = [1, 1, 5, 3.5]
...
def d2_pinball_score(
    ...
    Examples
    --------
    >>> from intelligen.metrics import d2_pinball_score
    >>> y_true = [1, 2, 3]
    >>> y_pred = [1, 3, 3]
...
def d2_absolute_error_score(
    ...
    Examples
    --------
    >>> from intelligen.metrics import d2_absolute_error_score
    >>> y_true = [3, -0.5, 2, 7]
    >>> y_pred = [2.5, 0.0, 2, 8]
